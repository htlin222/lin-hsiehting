...
metaDescription: "KRAS 在大腸癌曾被視為 undruggable，CodeBreaK 300 首度證明 sotorasib + panitumumab 第二線 mPFS 5.6 vs 2.2 個月（HR 0.49）。為何大腸癌必須合併 anti-EGFR、sotorasib 與 adagrasib + cetuximab 差異、QT 與肝指數監測、ctDNA 抗藥機制。"
tldr:
  - "KRAS G12C 占 mCRC 約 3–4%，所有 mCRC 確診時應同步測 RAS / BRAF / HER2 / MSI / NTRK"
  - "大腸癌 KRAS G12C 抑制劑必須合併 anti-EGFR，因 EGFR 反饋活化在 24–48 小時內重啟 MAPK"
  - "CodeBreaK 300：sotorasib 960 mg + panitumumab mPFS 5.6 vs 標準治療 2.2 個月（HR 0.49）"
  - "Adagrasib 易引起 QT 延長（≥G3 6%），治療前須評估 ECG 與電解質、避併用 CYP3A 強抑制劑"
  - "MSI-H mCRC 對 pembrolizumab ORR 43.8%、mPFS 16.5 個月，效益遠優於 KRAS G12C 標靶"

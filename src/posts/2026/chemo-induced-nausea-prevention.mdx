...
metaDescription: "化療不一定會吐:照 NCCN v2.2025 致吐分級給藥,急性期完全反應率可達 70–80%。本文整理 cisplatin / AC 高致吐四藥方案(NK1 + 5-HT3 + dexamethasone + olanzapine)、carboplatin 中致吐三藥組合,以及突破性嘔吐救援步驟、預期性嘔吐處理,並列出脫水紅旗症狀清單。"
tldr:
  - "致吐分級 HEC ≥ 90% / MEC 30–90% / LEC 10–30% / Min < 10%,對應 4 / 3 / 1–2 / 0 藥"
  - "Navari 2016 NEJM:加 olanzapine 後急性無噁心 74% vs 45%"
  - "Palonosetron 半衰期 40 小時,延遲期保護優於 ondansetron;NK1 是 CYP3A4 中度抑制劑"
  - "突破性嘔吐救援:加 olanzapine / prochlorperazine / metoclopramide,不要重複同類藥"
  - "脫水紅旗:24 小時無法進食、嘔吐 ≥ 5 次、體重 3 天降 ≥ 2 kg、合併發燒 → 立刻急診"

...
metaDescription: "CAR-T 健保 819 萬怎麼算、誰能拿、要等多久?整理 2023/11 起健保給付 tisagenlecleucel 兩類適應症(25 歲以下 r/r B-ALL、成人 r/r DLBCL ≥ 2L)、5 步申請流程、7 家執行醫院、CRS / ICANS 分級處置,以及 BCMA-CAR-T(ide-cel、cilta-cel)對骨髓瘤約 1,200–1,500 萬的自費選項。"
tldr:
  - "健保 819 萬以「暫時性支付」一生給付 1 次,涵蓋藥費 + 採集 + 住院 + tocilizumab"
  - "申請 5 步:評估 → 健保事前審查 2–4 週 → 白血球分離 → 製造 3–4 週 → 輸注 + 住院 7–14 天"
  - "ELIANA 試驗 r/r B-ALL CR+CRi 81%,JULIET 試驗 r/r DLBCL ORR 52%"
  - "CRS 60–80%(≥ Grade 3 約 20–25%);ICANS 20–40%(≥ Grade 3 10–15%)"
  - "BCMA CAR-T(ide-cel / cilta-cel)在台灣 TFDA 核准但健保未給付,自費約 1,200–1,500 萬"

...
metaDescription: "慢性骨髓性白血病 CML 在 BCR::ABL1 TKI 時代 10 年存活率 > 80%，但「能不能停藥」才是病人真正想問的問題。整理 imatinib、dasatinib、nilotinib、bosutinib、asciminib 五種 TKI 的取捨、ELN 2020 治療反應里程碑、EURO-SKI 試驗的 TFR 條件與復發後重啟策略。"
tldr:
  - "IRIS 10 年追蹤 imatinib 組總存活 83.3%，CML 已成為可長期控制的慢性病"
  - "停藥（TFR）條件：MR4 或 MR4.5 ≥ 2 年、TKI 累積 ≥ 5 年、無加速期病史、可每月 PCR 追蹤"
  - "EURO-SKI 停藥後 6 個月約 50% 分子復發，但重啟 TKI 幾乎全數可再達 MMR"
  - "Nilotinib 須空腹、避用糖尿病控制差者；dasatinib 避用慢性肺病；ibrutinib 心房顫動 12–16%"
  - "T315I 突變首選 ponatinib 或 asciminib 200 mg BID；ATP-binding site 抗藥可考慮 asciminib"

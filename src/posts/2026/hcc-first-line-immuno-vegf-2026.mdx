...
metaDescription: "晚期肝細胞癌一線從 sorafenib 單藥時代進入免疫合併三選一:atezolizumab+bevacizumab、durvalumab+tremelimumab STRIDE、nivolumab+ipilimumab。文章以 Child-Pugh、食道靜脈瘤、HBV / HCV 與抗凝風險為決策點,說明該選哪一個、Child B 灰色地帶與台灣 2026 健保。"
tldr:
  - "IMbrave150 atezo+bev mOS 19.2 vs sorafenib 13.4 個月(HR 0.66),為 Child A 首選"
  - "有食道靜脈瘤、近期 GI 出血或需抗凝者改走 HIMALAYA STRIDE 或 nivo+ipi"
  - "Bevacizumab 禁忌:近 6 個月內 ≥G3 出血、未處理高風險靜脈瘤、未控制高血壓"
  - "HBsAg(+) 或 HBV DNA 可測者:先用 entecavir / TAF,免疫治療下再活化率 5–10%"
  - "Child-Pugh B7 可個案討論、B8–B9 或失代償一律避免全身性治療"

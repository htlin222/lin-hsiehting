...
metaDescription: "ChatGPT、Claude、Gemini 編造論文 DOI 比例 10–40%，訓練資料延遲 6–18 個月，台灣健保條件多不熟悉。整理 AI 能做與不能做的場景、8 個必須找真人的高風險情境（急症、化療副作用、藥物劑量、保單理賠、遺傳諮詢）、5 個降低 hallucination 的提問技巧，以及論文 DOI 與 NCT 編號驗證工具。"
tldr:
  - "AI 編造論文與 DOI 比例 10–40%；訓練資料延遲 6–18 個月，最新試驗常缺失"
  - "AI 適合：解釋醫學名詞、翻譯論文摘要、整理問題清單、白話解釋治療概念"
  - "8 個絕對找真人：急性症狀、化療副作用 ≥ Grade 2、新藥劑量、過敏、保單理賠、重大決策"
  - "提問技巧：要求引用 NCCN/UpToDate、指定日期範圍、改問「該問醫師什麼」、分段問、驗證數字"
  - "通用聊天 AI 不是醫療器材，沒有臨床責任；當搜尋引擎升級版，不當醫師"
...
doi: "10.5281/zenodo.20131268"
conceptDoi: "10.5281/zenodo.20131267"
---

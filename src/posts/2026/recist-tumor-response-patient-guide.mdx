...
metaDescription: "RECIST 1.1 用最長徑總和變化分四類:CR(全消)、PR(縮 ≥ 30%)、SD、PD(增 ≥ 20% 且 ≥ 5 mm 或新病灶)。免疫治療用 iRECIST 處理假惡化、淋巴瘤用 Lugano、骨髓瘤用 IMWG、GIST 用 Choi、PET 用 PERCIST。本文用病人語言解釋影像報告數字、SD 是否算成功、為什麼不同癌別用不同標準。"
tldr:
  - "PR = 腫瘤總徑縮 ≥ 30% 且無新病灶;PD 需 ≥ 20% 同時絕對值 ≥ 5 mm"
  - "SD 是光譜:可能 indolent、藥物僵持或無效未到 PD;試驗常用 CBR(CR+PR+SD ≥ 6 月)"
  - "免疫治療 5–10% 病人出現 pseudoprogression,iRECIST iUPD 要 4–8 週後再確認"
  - "GIST 用 imatinib 後體積常不變、CT 密度(HU)下降,Choi 標準同時看 size 與 density"
  - "看報告四件事:本次分類、變化百分比、是否新病灶、跟 baseline 還是 nadir 比"
...
doi: "10.5281/zenodo.20112724"
conceptDoi: "10.5281/zenodo.20112723"
---

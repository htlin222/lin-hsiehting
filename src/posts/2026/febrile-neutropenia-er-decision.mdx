...
metaDescription: "化療發燒最危險的不是體溫,而是嗜中性球絕對值（ANC）。ANC<500 加上耳溫 ≥38.3℃ 即診斷嗜中性球低下發燒（FN）,IDSA 要求 60 分鐘內第一劑廣效抗生素。文章拆解 MASCC≥21 低風險如何走口服居家、CISNE 補強工具、何時非住院不可、G-CSF 一級 vs 二級預防,並附化療卡與居家處理 SOP。"
tldr:
  - "FN 標準:ANC<500/µL + 耳溫單次 ≥38.3℃ 或持續 ≥38.0℃ 超過 1 小時"
  - "化療後第 7–14 天 nadir 風險最高,任何發燒先打電話、不要自行吃退燒藥觀察"
  - "MASCC ≥21、口服可靠、住處 1 小時到急診,可考慮 cipro + amox/clav 居家"
  - "高風險首選:cefepime 2g IV q8h 或 pip-tazo 4.5g IV q6h,60 分鐘內首劑"
  - "化療方案 FN 風險 ≥20% 應從第一個療程起 G-CSF 一級預防"

...
metaDescription: "化療結束後仍累到提不起勁?癌因性疲憊(CRF)休息也無法緩解,NCCN 建議疲憊評分 ≥ 4 分就要主動評估。本文整理量表選擇(NRS、FACIT-F、BFI)、必須先排除的 9 個可治療原因(貧血、甲狀腺、憂鬱、睡眠等),以及運動 FITT 處方、American ginseng 與 methylphenidate 的證據等級。"
tldr:
  - "Mustian JAMA Oncol 2017 統合 113 RCT:運動 + CBT 效果優於藥物,藥物整體不顯著"
  - "ACSM 處方:有氧 150 分鐘/週 + 阻力 2–3 次/週,RPE 5–6 / 10(能說話不能唱歌)"
  - "American ginseng(西洋參)2000 mg/d 是少數有 RCT 支持的補充劑,亞洲人參證據不足"
  - "Methylphenidate 效應量小(SMD ≈ 0.3),僅在排除可治療原因 + 非藥物無效後考慮"
  - "Modafinil 在 Jean-Pierre 2010 大型試驗整體陰性,NCCN 不建議常規使用"
